	...
	<div style="height:100%; background-color: #fff;">
		...
		<div class="content" >
			...
			<div class="detail">
				...
				<ul>
					<li><span>申请贷款额度</span><span class="right">{{loanAmount}}</span></li>
...
<script>
	...
	import { showProductById, getAllApplyByApply} from "@/api/getData"
			...
			async getAllApply() {
				try {
					...
					if(res.errorCode == 0) {
						...
						this.productName = apply.productName;
						this.bankName = apply.bankName;
						if(apply.loanAmount){
							this.loanAmount = apply.loanAmount+"万元";							
						}else{
							this.loanAmount = "--";
						}
						if(apply.loanTerm){
