	...
	<div>
		...
		<div class="list">
			<div class="list_tip">
				...
				<span>业务办理须知：申请贷款前，请确保您在贵公司所在地工商银行已办理借记卡和U盾（或密码器），并下载手机银行APP。</span>
			</div>
			<h3>申请信息</h3>
			<div class="list_cont">
				<div class="form">
					...
					<p>
						<label><span>*</span>工商银行对公账户:</label>
						<input type="text" placeholder="请输入工商银行对公账户" v-model="applyFrom.gsyhdgNo">
					</p>
					<p class="info">提示：工商银行对公账号需与申请企业所在地一致</p>
					<p class="other">
						<label><span>*</span>申请人类型:</label>
						<input type="text" placeholder="请选择申请人类型" v-model="applyPersonType.name">
						<i class="right">&nbsp;</i>
					</p>
					<p>
			...
			<div class="list_cont">
				<div class="form">
					...
					<p class="info">提示：申请人工商银行号归属地需与申请企业所在地一致</p>
					<p>
...
<script>
	...
	import { sendMobileCode, checkMobileCode, checkRealName, submitApplyStepone } from "@/api/getData"
	...
	export default {
		...
		methods: {
			...
			async submitApplySteponeData() {
				...
				dataNx.openBankName = this.product.bankName;
				dataNx.gsyhdgNo = this.applyFrom.gsyhdgNo;
