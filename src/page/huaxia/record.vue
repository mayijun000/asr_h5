<template>
	<div style="height: 100%; background-color: #fff;">
		<headTop title="还款记录" showBack="1"></headTop>
		<div class="list">
			<h3>还款记录表</h3>
		...
		<div class="project-tab">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				  ...
				  <tr v-for="item in finalRepayResultList">
...
<script>
	...
	import { getRepayList } from "@/api/getData"
	...
	export default {
		...
		methods: {
			...
			async getRepayList() {
				try {
					const res = await getRepayList({
						dueNo: this.dueNo,
						applyNo:this.applyNo
					});
					if(res.errorCode == 0) {
						this.finalRepayResultList = res.dataBody.finalRepayResultList;
					} else {
